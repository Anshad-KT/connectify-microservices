...
import { assignmentsRoutes,projectsRoutes,resourcesRoutes,tasksRoutes } from "./routers/index.js";
...
app.use('/api/projects/assignments',assignmentsRoutes)
app.use('/api/projects/tasks',tasksRoutes)
app.use('/api/projects/resources',resourcesRoutes)
